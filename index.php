...
<head>
  ...
  <title>Saifur's - Student Vocabulary</title>
  <!-- General CSS Files -->
          ...
          <div class="card-body">
            <div class="table-responsive">
              ...
              <?php
                ...
                $readWordResult = mysqli_query($conn,$readWord) or die("Read words for home page query failed - Check index.php");
          ...
          <div class="card-footer text-right">
            <nav class="d-inline-block">
              <?php
                ...
                if (mysqli_num_rows($paginationQResult)>6) {
